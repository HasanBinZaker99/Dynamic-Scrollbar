...
class TransfersController extends Controller
{
    ...
    public function addTransferPost(Request $request){
        ...
        $transfer->save();
        return  redirect()->route('transferList')->with('Create_Message', 'New Transfer added successfully');
    }
    ...
    public function transferDelete(Request $request){
        ...
        return  redirect()->route('transferList')->with('Delete_Message', 'New Transfer deleted successfully');
    }
    ...
    public function UpdateTransfer(Request $request){
        ...
        $transfer->Description = $request->description;
        $transfer->save();
        return  redirect()->route('transferList')->with('Update_Message', 'New Transfer added successfully');
    }
