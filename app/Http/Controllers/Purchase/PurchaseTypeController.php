...
class PurchaseTypeController extends Controller
{
    ...
    function addPurchaseType(Request $req)
    {
        ...
        $user->code= $req->code;
        $user->save();
        return redirect('purchase-type-list')->with('Create_Message', 'New Purchase Type Created Successfully');
    }
    ...
    function purchasetypedelete(Request $request)
    {
        ...
        return redirect('purchase-type-list')->with('Delete_Message', 'Purchase Type Deleted Successfully');
    }
    ...
    function purchaseTypeUpdate(Request $req){
        ...
        $data->code = $req->code;
        $data->save();
        return redirect('purchase-type-list')->with('Update_Message','Purchase Type Updated Successfully');
    }
