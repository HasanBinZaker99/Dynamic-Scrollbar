...
//        return view('Setting.searchCompanyInfo', ['$companyInfo' => $data]);
    ...
    public function businessBranch(){
        ...
        return view('Setting.businessBranch',['businessBranch'=>$businessBranch]);
    }
...
//        die();
        ...
        $businessBranch->save();
        return redirect('/business-branch')->with('Create_Message','New Business Branch Created Successfully');
    }
    ...
    public function deleteBranch(Request $request){
        ...
        return redirect('/business-branch')->with('Delete_Message','Business Branch Deleted Successfully');
    }
    ...
    public function updateBusinessBranch(Request $request,$id){
        ...
        $businessBranch->note = $request->note;
        $businessBranch->save();
        return redirect('/business-branch')->with('Update_Message','Business Branch Updated Successfully');
    }
