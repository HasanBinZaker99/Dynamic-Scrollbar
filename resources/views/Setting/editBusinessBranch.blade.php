                                ...
                                <form action="{{route('updateBusinessBranch',['id'=>$businessBranch['id']])}}" method="POST"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="companyId" value="{{$businessBranch->companyId}}"/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-md-4 ">
                                            ...
                                            <div class="search_select_box">
                                                <select id="status" class="form-control " name="status" data-live-search="true" >
                                                    <option value="active" {{ ($businessBranch->status)== 'active' ? 'selected':'' }}>Active</option>
                                                    <option value="inActive" {{ ($businessBranch->status)== 'inActive' ? 'selected':'' }}>Inactive</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="phoneNo" value="{{$businessBranch->companyId}}"/>
                                        </div>
                                        <div class="col-md-4">
                                            <label>Email</label>
                                            <input type="email" name="email" value="{{$businessBranch->email}}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <textarea class="form-control" id="comment" name="branchLocation" value="{{$businessBranch->branchLocation}}"></textarea>
                                        </div>
                                        <div class="col-md-4">
                                            <label>Note</label>
