...
@section('content')
                        ...
                        <div class="table-responsive">
                          ...
                          ?>
                                    <tr>
                                        ...
                                        <td>{{$labour->grandTotal}}</td>
                                        <td>{{$labour->CSFCAmount}}</td>
    ...
    <script>
        function create()
        {
            ...
            Toast.fire({
                icon: 'success',
                title: 'New LabourBill Created Successfully'
            })
        }
        function wise_words()
        {
            ...
            Toast.fire({
                icon: 'success',
                title: 'LabourBill Deleted Successfully'
            })
        }
        function update()
        {
            ...
            Toast.fire({
                icon: 'success',
                title: 'LabourBill Updated Successfully'
            })
        }
    </script>
