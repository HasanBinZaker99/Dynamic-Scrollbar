...
@section('content')
            ...
            <div class="col-lg-12 bg-white mx-auto mt-5">
                ...
                <div class="card bg-white">
                    ...
                    <div class="card-body bg-white">
                        ...
                        <div class="bg-white">
                            <form action="/labour-type-search" method="GET">
                                <div class="form-group row">
                                    <label class="col-md-6">
                                        <input type="text" class="form-control bg-white" name="query" value="Search"/>
                                    </label>
                                    <div class="col-md-6 ml-0">
                                        <span class="float-right col-md-6"><a href="/add-labour-type-form" class="btn btn-success float-right">+Add</a></span>
    ...
    <script>
        function create()
        {
            ...
            Toast.fire({
                icon: 'success',
                title: 'New Labour Type Created Successfully'
            })
        }
        function wise_words()
        {
            ...
            Toast.fire({
                icon: 'success',
                title: 'Labour Type Deleted Successfully'
            })
        }
        function update()
        {
            ...
            Toast.fire({
                icon: 'success',
                title: 'Labour Type Updated Successfully'
            })
        }
    </script>
@endsection
