                            ...
                            <table class="table table-bordered mb-0" id="myTable">
                                ...
                                @foreach ($applyLeaves as $applyLeave)
                                    <tr>
                                        ...
                                        <td>
                                        <select class="form-control" name="status" id="status" onchange="change(this.value,{{$applyLeave->id}})">
                                            <option @if($applyLeave->status === "0") selected @endif value="0">Unapprove</option>
                                            <option @if($applyLeave->status === "1") selected @endif value="1">Approve</option>
                                            <option @if($applyLeave->status === "2") selected @endif value="2">Rejected</option>
                                        </select>
                                        </td>
                                        <td>
