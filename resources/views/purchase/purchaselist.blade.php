        ...
        <div class="row">
            <div class="col-lg-12 bg-white mx-auto mt-5">
                ...
                <div class="card bg-white">
                    <h4 class="card-header">Purchase proposal List</h4>
...
{{--                                            </a>--}}
                                            ...
                                            <a href="/purchase-approved/{{$purchase['id']}}" style="margin-top: 1rem; " class="btn btn-warning btn-sm" title="Update">
                                                Approve Now
                                            </a>
                                        </td>
