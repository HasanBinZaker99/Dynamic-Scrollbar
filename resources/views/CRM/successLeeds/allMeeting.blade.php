                    ...
                    @foreach ($meetings as $meeting)
                        ...
                        <div class="col-md-8 mb-0">
                            <div class="card-body pt-2 p-0">
                                <h5 class="card-title"><b>{!! date('h:i A', strtotime($meeting->meetingDateAndTime)) !!}</b></h5><br>
                                <h5 class="card-title">{{$meeting->phoneNo}}</h5><br>
                                ...
                                ?>
                                <p class="card-text">
                                    Created By <span class="text-primary">{{$user->name}}</span> on {{$meeting->created_at}}
                                </p>
                                <p class="card-text">
